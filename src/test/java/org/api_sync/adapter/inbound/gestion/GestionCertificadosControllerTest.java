...
class GestionCertificadosControllerTest {

    @Mock
    private GestionCertificadosService certificadoService;

    @InjectMocks
    private GestionCertificadosController certificadosController;
